...
<head>
  ...
  <title>Kelola Hutang - Money</title>
...
<?php require 'navbar.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Daftar Hutang</h1>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php 
$query = mysqli_query($koneksi,"SELECT * FROM hutang where jumlah > 1000 ORDER BY tenggat ASC");
$no = 1;
...
<div class="form-group">
<label>Tanggal</label>
<input type="date" name="tgl_pinjam" class="form-control" value="<?php echo $row['tgl_pinjam']; ?>">      
</div>

<div class="form-group">
<label>Tenggat</label>
<input type="date" name="tenggat" class="form-control" value="<?php echo $row['tenggat']; ?>">      
</div>

<div class="form-group">
<label>Sumber Hutang</label>
<input type="text" name="sumber_hutang" class="form-control" value="<?php echo $row['sumber_hutang']; ?>">      
</div>
  ...
  <div id="myModalTambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		Sumber Hutang : 
         <input type="text" class="form-control" name="sumber_hutang">
		Tenggat : 
         <input type="date" class="form-control" name="alasan">
        </div>
        <!-- footer modal -->
        <div class="modal-footer">
